...
LOG_DIR="/home/abc/chain-n/Mysticeti/metanode/logs/node_${NODE_ID}/go-master"
STDOUT_LOG="/home/abc/chain-n/Mysticeti/metanode/logs/node_${NODE_ID}/go-master-stdout.log"
ARG="${2:-50}"
