...
# - Node 4: Sync-Only Node (chỉ đồng bộ data, không tham gia validator)
# - Sử dụng config/node_4.toml (có initial_node_mode = "SyncOnly")
...
print_info "🚀 Khởi động Node $NODE_ID (Sync-Only) trong tmux session '$TMUX_SESSION'..."
