...
# Script để khởi động lại Rust Consensus Node 0 (Validator + Executor)
# GIỮ NGUYÊN DỮ LIỆU CŨ, KHÔNG CLEANUP.
# - Node 0: Validator với executor enabled
...
LOG_FILE="$METANODE_ROOT/logs/metanode-$NODE_ID.log"
...
print_step "Bước 4: Đảm bảo thư mục logs tồn tại..."
mkdir -p "$(dirname "$LOG_FILE")"

# Step 5: Start Node
print_step "Bước 5: Restart Rust Consensus Node $NODE_ID..."
